...
// Update provides a mock function with given fields: ctx, orderUUID, order
func (_m *OrderRepository) Update(ctx context.Context, orderUUID uuid.UUID, order model.Order) error {
...
//   - orderUUID uuid.UUID
//   - order model.Order
func (_e *OrderRepository_Expecter) Update(ctx interface{}, orderUUID interface{}, order interface{}) *OrderRepository_Update_Call {
	return &OrderRepository_Update_Call{Call: _e.mock.On("Update", ctx, orderUUID, order)}
}

func (_c *OrderRepository_Update_Call) Run(run func(ctx context.Context, orderUUID uuid.UUID, order model.Order)) *OrderRepository_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *OrderRepository_Update_Call) RunAndReturn(run func(context.Context, uuid.UUID, model.Order) error) *OrderRepository_Update_Call {
	_c.Call.Return(run)
	return _c
}
