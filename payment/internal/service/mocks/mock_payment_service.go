...
func (_m *PaymentService) PayOrder(ctx context.Context) (string, error) {
	ret := _m.Called(ctx)
...
func (_c *PaymentService_PayOrder_Call) RunAndReturn(run func(context.Context) (string, error)) *PaymentService_PayOrder_Call {
	_c.Call.Return(run)
	return _c
}
