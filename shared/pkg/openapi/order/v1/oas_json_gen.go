...
// Encode implements json.Marshaler.
func (s *ProcessOrderPaymentRequest) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *ProcessOrderPaymentRequest) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("payment_method")
		s.PaymentMethod.Encode(e)
	}
...
var jsonFieldsNameOfProcessOrderPaymentRequest = [1]string{
	0: "payment_method",
}

// Decode decodes ProcessOrderPaymentRequest from json.
func (s *ProcessOrderPaymentRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ProcessOrderPaymentRequest to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ProcessOrderPaymentRequest")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfProcessOrderPaymentRequest) {
					name = jsonFieldsNameOfProcessOrderPaymentRequest[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *ProcessOrderPaymentRequest) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *ProcessOrderPaymentRequest) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes ProcessOrderPaymentRequestPaymentMethod as json.
func (s ProcessOrderPaymentRequestPaymentMethod) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes ProcessOrderPaymentRequestPaymentMethod from json.
func (s *ProcessOrderPaymentRequestPaymentMethod) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ProcessOrderPaymentRequestPaymentMethod to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch ProcessOrderPaymentRequestPaymentMethod(v) {
	...
	default:
		*s = ProcessOrderPaymentRequestPaymentMethod(v)
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s ProcessOrderPaymentRequestPaymentMethod) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *ProcessOrderPaymentRequestPaymentMethod) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *ProcessOrderPaymentResponse) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *ProcessOrderPaymentResponse) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("transaction_uuid")
...
var jsonFieldsNameOfProcessOrderPaymentResponse = [1]string{
	0: "transaction_uuid",
}

// Decode decodes ProcessOrderPaymentResponse from json.
func (s *ProcessOrderPaymentResponse) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode ProcessOrderPaymentResponse to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode ProcessOrderPaymentResponse")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfProcessOrderPaymentResponse) {
					name = jsonFieldsNameOfProcessOrderPaymentResponse[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *ProcessOrderPaymentResponse) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *ProcessOrderPaymentResponse) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
