...
// Package user.v1 contains API for managing user operations
...
// Response to request to register user
...
// Response to request to get user data
...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\aGetUser\x12\x17.user.v1.GetUserRequest\x1a\x18.user.v1.GetUserResponseBFZDgithub.com/pinai4/spaceship-factory/shared/pkg/proto/user/v1;user_v1b\x06proto3"
